...
class TestYouTubeTranscriptApi(TestCase):
    ...
    @patch('youtube_transcript_api_wokelo.YouTubeTranscriptApi.get_transcript')
    ...
    @patch('youtube_transcript_api_wokelo.YouTubeTranscriptApi.get_transcript', side_effect=Exception('Error'))
